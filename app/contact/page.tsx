      ...
      <Content bg="bg-gray-100">
        <div className="overflow-hidden max-w-6xl max-lg:max-w-2xl mx-auto p-4">
          <div className="grid lg:grid-cols-2 items-center gap-8">
            <div className="py-8 px-8 sm:px-10 bg-white rounded-3xl">
              ...
              <form>
                ...
                <button
                  type="button"
                  className="mt-8 flex items-center justify-center text-sm font-medium w-full rounded-md px-4 py-3 tracking-wide text-white cursor-pointer bg-primary hover:bg-black border-0"
                >
                  <svg
              ...
              <ul className="mt-4 flex flex-wrap justify-center gap-4 lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2">
                <li className="flex items-center text-black hover:text-primary font-medium">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16px"
                    height="16px"
            ...
            <div className="z-10 relative h-full max-lg:min-h-[400px]  rounded-3xl overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12570.495181274418!2d23.712695085137035!3d38.032549050743235!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14a1a2f9156a0e2d%3A0x73fbc3a1c02e896c!2sAgioi%20Anargyroi!5e0!3m2!1sen!2sgr!4v1761302237254!5m2!1sen!2sgr"
